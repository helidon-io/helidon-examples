...
public class MenuItemsIngestor {
     ...
     *
     * @param coherenceEmbeddingStore    the embedding store where generated embeddings are stored
     ...
     */
    @Service.Inject
    MenuItemsIngestor(CoherenceEmbeddingStore coherenceEmbeddingStore,
                      EmbeddingModel embeddingModel,
                      MenuItemsService menuItemsService) {
        this.embeddingStore = coherenceEmbeddingStore;
