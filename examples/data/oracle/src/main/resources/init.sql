...
CREATE TABLE POKEMON (ID INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, NAME VARCHAR(255) UNIQUE NOT NULL, TYPE_ID INTEGER NOT NULL)

ALTER TABLE POKEMON ADD CONSTRAINT FK_POKEMON_TYPE_ID FOREIGN KEY (TYPE_ID) REFERENCES TYPE (ID)
CREATE SEQUENCE SEQ_GEN_IDENTITY START WITH 20
