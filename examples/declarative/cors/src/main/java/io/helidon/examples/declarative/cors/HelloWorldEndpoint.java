...
@Cors.AllowMethods("POST") // the only allowed method for CORS operations is POST, other methods will be only same origin
@Cors.AllowOrigins("${app.cors.allow-origins:http://www.example.com}") // value with configuration override
@Cors.MaxAgeSeconds(60)
