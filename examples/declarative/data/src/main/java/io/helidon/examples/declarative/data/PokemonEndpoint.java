...
import io.helidon.examples.declarative.data.model.PokemonRepository;
import io.helidon.examples.declarative.data.model.Type;
import io.helidon.examples.declarative.data.model.TypeRepository;
...
class PokemonEndpoint {
    ...
    PokemonDto insertPokemon(PokemonDto pokemonDto) {
        ...
        return PokemonDto.create(pokemonRepository.insert(new Pokemon(pokemonDto.name(), type)));
    }
