...
/**
 * {@link io.helidon.examples.declarative.data.model.Owner} entity data repository interface.
 * <p>
 * {@code OwnerRepository} interface acts as a data access layer, encapsulating the logic for interacting
 * with the {@link io.helidon.examples.declarative.data.model.Owner} entity data.
 *
 * @see io.helidon.examples.declarative.data.model.Owner
 */
@Data.Repository
