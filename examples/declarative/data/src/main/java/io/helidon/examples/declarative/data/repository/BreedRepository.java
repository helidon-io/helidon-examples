...
/**
 * {@link io.helidon.examples.declarative.data.model.Breed} entity data repository interface.
 * <p>
 * <p>
 * This interface acts as a data access layer, encapsulating the logic for interacting
 * with the {@link io.helidon.examples.declarative.data.model.Breed} entity data.
 *
 * @see io.helidon.examples.declarative.data.model.Breed
 */
@Data.Repository
