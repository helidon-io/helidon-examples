 ...
 */
package io.helidon.examples.declarative.data.jdbc.mysql;
...
import io.helidon.examples.declarative.data.jdbc.mysql.model.PokemonRepository;
import io.helidon.examples.declarative.data.jdbc.mysql.model.PokemonType;
import io.helidon.examples.declarative.data.jdbc.mysql.model.PokemonTypeRepository;
...
/**
 * Exercises the HTTP endpoints and generated JDBC repositories with MySQL.
 */
...
class PokemonApplicationTest {
    ...
    private static final class PokemonMySqlContainer extends MySQLContainer<PokemonMySqlContainer> {
        private PokemonMySqlContainer() {
            super(PokemonApplicationTest.IMAGE);
