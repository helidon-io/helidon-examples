...
/**
 * Creates and populates the example schema before the web server starts.
 */
@Service.Singleton
...
final class SchemaInitializer {
    ...
    /**
     * Creates the schema initializer with the Default JDBC Client.
     *
     * @param jdbcClient registry managed JDBC client
     */
    @Service.Inject
    SchemaInitializer(@Data.ProviderType("jdbc")
