# Helidon Examples DbClient Oracle
...
```shell
java -jar target/helidon-examples-dbclient-oracle.jar
```

Restart the application:
```shell
java -Ddb.init=false -jar target/helidon-examples-dbclient-oracle.jar
```
