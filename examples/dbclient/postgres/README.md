# Helidon Examples DbClient Postgres
...
```shell
java -jar target/helidon-examples-dbclient-postgres.jar
```

Restart the application:
```shell
java -Ddb.init=false -jar target/helidon-examples-dbclient-postgres.jar
```
