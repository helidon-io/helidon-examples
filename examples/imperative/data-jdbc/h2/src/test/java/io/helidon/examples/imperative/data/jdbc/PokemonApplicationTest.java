...
class PokemonApplicationTest {
    ...
    void rejectsNullNameBeforeJdbc() {
        // Reject a null name before the request reaches JdbcClient.
    ...
    void rejectsBlankNameBeforeJdbc() {
        // Reject a blank name before the request reaches JdbcClient.
        assertBadRequest(Json.createObjectBuilder()
                                 .add("name", "  ")
                                 .add("type", "Fire")
                                 .build());
    ...
    void rejectsNullTypeBeforeJdbc() {
        // Reject a null type before the request reaches JdbcClient.
        assertBadRequest(Json.createObjectBuilder()
                                 .add("name", "Charmander")
                                 .addNull("type")
                                 .build());
    ...
    void rejectsBlankTypeBeforeJdbc() {
        // Reject a blank type before the request reaches JdbcClient.
        assertBadRequest(Json.createObjectBuilder()
                                 .add("name", "Charmander")
                                 .add("type", "  ")
                                 .build());
